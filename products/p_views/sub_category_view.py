...
from ..p_serializers.sub_category_serializers import SubCategorySerializer
...
class SubCategoryViewSet(viewsets.ModelViewSet):
    ...
    search_fields = ['name','description', 'code', 'category']
    
    filter_fields = ['name','description', 'code', 'category']
